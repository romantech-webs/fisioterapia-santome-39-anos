  ...
  return (
    <html lang="es">
      <head>
        ...
        <script dangerouslySetInnerHTML={{ __html: `window.__WIDGET_API_URL="https://automatizacion-webs.vercel.app";window.__PROJECT_ID="fisioterapia-santome-39-anos";` }} />

        <script
          src="https://automatizacion-webs.vercel.app/widget.js"
          data-project-name="Fisioterapia Santomé 39 años de experiencia"
          data-api-url="https://automatizacion-webs.vercel.app"
          data-project-id="fisioterapia-santome-39-anos"
          data-primary-color="#896854"
          defer
        ></script>
      </head>
      <body className="font-sans">
        ...
        <script dangerouslySetInnerHTML={{ __html: `
          (function(){
            ...
            var pid="fisioterapia-santome-39-anos";
